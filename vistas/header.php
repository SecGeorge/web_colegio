...
if ($_SESSION['acceso']==1) {
  echo '  <li class="treeview">
        ...
        ?>     
        <li><a href="http://localhost/biblioteca-cmg/" target="_blanck"><i class="fa  fa-exclamation-circle"></i> <span>Biblioteca</span><small class="label pull-right bg-yellow">Externo</small></a></li>   
